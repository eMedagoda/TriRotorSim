...
%     end
    ...
    rC = K_phi*PiMinusPi(psi_C - X(9,i));
    UU5 = K_p*(rC - X(6,i));
    U(5,i) = U(5,i) + UU5;
...
% ylabel('theta')
hold on
plot(t,X(5,:)*RAD2DEG,col2,'Linewidth',2)
subplot(3,1,3)
...
xlabel('Time (s)')
hold on
plot(t,X(6,:)*RAD2DEG,col2,'Linewidth',2)
hold on
...
xlabel('Time (s)')
hold on
plot(t,X(4,:)*RAD2DEG,col2,'Linewidth',2)
hold on
