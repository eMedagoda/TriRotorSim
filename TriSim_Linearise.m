function [A B] = TriSim_Linearise(X_TRIM,U_TRIM)

Xdot_TRIM = TriSim_StateRates(X_TRIM,U_TRIM);
...
for i = 1:num_states
    ...
    Xdot_PERT_X = TriSim_StateRates(X_PERT,U_TRIM);
...
for i = 1:num_controls
    ...
    Xdot_PERT_U = TriSim_StateRates(X_TRIM,U_PERT);
